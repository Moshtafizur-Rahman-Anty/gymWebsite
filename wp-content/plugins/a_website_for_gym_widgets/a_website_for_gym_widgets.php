...
Plugin Name: A Website For Gym - Widgets
Plugin URl:
 ...
 */
class A_website_for_Gym_Widget extends WP_Widget {
	...
	function __construct() {
		parent::__construct(
			'a_website_for_gym_classes', // Base ID
			esc_html__( 'Website for Gym- Classes List', 'text_domain' ), // Name
...
function a_website_for_gym_classes_widget() {
    register_widget( 'A_website_for_Gym_Widget' );
}
add_action( 'widgets_init', 'a_website_for_gym_classes_widget' );